...
NUM_EPISODES = 500000  # Max episodes (will stop early if converged)
...
EVAL_EPISODES = 100  # Run 100 episodes per evaluation
NO_IMPROVE_THRESHOLD = 5  # Stop after 5 evals with no improvement
